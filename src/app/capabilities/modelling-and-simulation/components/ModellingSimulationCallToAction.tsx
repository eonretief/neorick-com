                    ...
                    <div className="flex flex-col items-center justify-center text-center space-y-8">
                        ...
                        <div className="w-full pt-8">
                            <p ref={paragraphRef} className="text-sm font-light text-white/80 mx-auto max-w-lg leading-relaxed">
                                At Neorick, we harness computational modelling and simulation to decode complexities,
                                delivering precise insights that inform better decisions and drive innovation. With our
                                expertise in digital twins, quantitative analysis, and decision support, we create models
                                that are accurate, actionable, and tailored to your challenges—turning uncertainty into
                                strategic advantage. Let's discuss how we can model solutions that propel your business
                                forward.
                            </p>
                        </div>
