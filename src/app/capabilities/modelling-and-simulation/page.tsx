...
import { modellingSimulationSections } from "./components/ModellingSimulationSections"
import { track } from "@vercel/analytics"
import { useEffect } from "react"

export default function ModellingSimulationPage() {
    ...
    useEffect(() => {
        track("Page View", {
            page: "modelling-and-simulation",
            pageTitle: "Modelling & Simulation",
        })
    }, [])
    ...
    return (
        <div className="h-screen w-screen overflow-hidden">
            ...
            <ScrollProgressBar
                sections={modellingSimulationSections}
                pageTitle="Modelling & Simulation"
                theme="light"
