                    ...
                    <div className="flex flex-col items-center justify-center text-center space-y-8">
                        ...
                        <div className="w-full pt-8">
                            <p ref={paragraphRef} className="text-sm font-light text-white/80 mx-auto max-w-lg leading-relaxed">
                                At Neorick, we harness AI to deliver ethical, impactful solutions that solve real problems
                                and drive sustainable growth. With our depth in machine learning, generative tools, and
                                responsible practices, we ensure AI integrates seamlessly, maximizing value without risks
                                or complexity. Let's collaborate to tailor AI that aligns with your vision and transforms
                                your operations.
                            </p>
                        </div>
