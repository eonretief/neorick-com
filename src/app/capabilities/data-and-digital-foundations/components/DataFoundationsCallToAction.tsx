                ...
                <Container className="px-6">
                    ...
                    <div className="flex flex-col items-center justify-center text-center space-y-8">
                        ...
                        <div className="w-full">
                            ...
                            >
                                Ready to Build Lasting Data Foundations?
                            </h2>
                        </div>
                        ...
                        <div className="w-full pt-8">
                            <p ref={paragraphRef} className="text-sm font-light text-white/80 mx-auto max-w-lg leading-relaxed">
                                At Neorick, we deliver data and digital foundations that prioritize simplicity and real impact, turning
                                your data into a reliable asset for better decisions and sustainable growth. With our depth of
                                expertise, we ensure quality at every step, avoiding complexity to focus on what truly adds value for
                                your business. Let's discuss how we can tailor a foundation that evolves with you.
                            </p>
                        </div>
